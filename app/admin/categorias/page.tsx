...
export default async function CategoriasPage() {
  ...
  const { data: categorias, error } = await supabase
    .from('categorias')
    .select('id, slug, label, bloco, icon_name, instrucao_publica, aviso_legal, template_descricao, email_destino, ativo, ordem, criado_em, atualizado_em, permite_anonimato')
