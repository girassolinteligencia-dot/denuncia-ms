                 ...
                 <div>
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center gap-4 sm:gap-10 mt-4 pb-6 border-b border-border">
                       ...
                       <div className="flex items-center gap-2 text-muted text-[11px] sm:text-xs font-bold shrink-0">
                          ...
                          Ocorrido em: {denuncia.data_ocorrido ? new Date(denuncia.data_ocorrido).toLocaleDateString('pt-BR') : 'Não informada'}
                       </div>
                    </div>
                 </div>
           ...
           <div className="bg-white rounded-card border border-border p-6 shadow-card">
              ...
              <div className="space-y-4 relative before:absolute before:left-2.5 before:top-2 before:h-[calc(100%-16px)] before:w-0.5 before:bg-surface">
                 <div className="relative pl-8">
                    ...
                    <p className="text-[9px] text-muted font-bold">{new Date(denuncia.criado_em).toLocaleString('pt-BR')}</p>
                 </div>
